          ...
          <div id={openLinks ? "open" : "close"} className="flex justify-end gap-10 text-gray-600 w-content-fit">
            ...
            <Dropdown>
              ...
              <Dropdown.Menu className='e-caret-hide'>
                <Dropdown.Item ><ul id='navbar'><Link to='/Team'> Meet The Team </Link></ul></Dropdown.Item>
                <Dropdown.Item ><ul id='navbar'><Link to='/about'> About</Link></ul></Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
